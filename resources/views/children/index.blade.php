...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm mb-6">
        <form action="{{ route('children.index') }}" method="GET" class="flex flex-col lg:flex-row flex-wrap items-center gap-4">
            ...
            <div>
                <a href="{{ route('children.index') }}" class="flex items-center justify-center w-full sm:w-auto bg-slate-50 text-slate-500 hover:bg-slate-100 px-4 py-2 rounded-xl font-medium transition text-sm">Reset</a>
            </div>
            @endif
        </form>
    </div>
